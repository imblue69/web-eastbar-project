    ...
    <div id="app-sidepanel" class="app-sidepanel">
        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <div class="app-branding">
                <a class="app-logo" href="../admin/"><img class="rounded-circle logo-icon me-2" src="../assets/images/logo.jpg" alt="logo"><span class="logo-text">East Bar</span></a>
            </div><!--//app-branding-->
                ...
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link <?php echo (isset($_GET['page']) && ($_GET['page'] == 'manage-user' || $_GET['page'] == 'user-edit' || $_GET['page'] == 'user-view' || $_GET['page'] == 'add-user' || $_GET['page'] == 'user-resetpass')) ? 'active' : '' ?>" href="?page=manage-user">
                            ...
                            <span class="nav-link-text">จัดการข้อมูลผู้ใช้ระบบ</span>
                        </a><!--//nav-link-->
                    </li><!--//nav-item-->
