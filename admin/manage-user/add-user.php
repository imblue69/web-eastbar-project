                            ...
                            if (isset($_POST['add_user'])) {
                                ...
                                if (empty($username)) {
                                    ...
                                    if (mysqli_num_rows($call_back_query_check_username) > 0) {
                                        $_SESSION['message'] = "มีชื่อผู้ใช้นี้ไปแล้ว";
                                        ...
                                        mysqli_stmt_bind_param($stmt, "ssssssssssss", $username, $firstname, $lastname, $nickname, $address, $telephone, $email, $sex, $filename, $password, $salt_user, $usertype);
                            ...
                            <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="usertype" id="inlineRadioj1" value="admin" checked>
                                        <label class="form-check-label" for="inlineRadioj1">Admin</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="usertype" id="inlineRadioj2" value="manager">
                                        <label class="form-check-label" for="inlineRadioj2">Manager</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="usertype" id="inlineRadioj3" value="employee">
                                        <label class="form-check-label" for="inlineRadioj3">Employee</label>
                                    </div>
                                </div>
