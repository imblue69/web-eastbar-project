												...
												<td>
													...
													<?php if ($user['user_type'] !== 'admin') : ?>
														...
														<form action="../sql/code.php" method="POST" class="d-inline mt-1">
															...
															<button type="submit" onclick="return confirm('ยืนยันการลบผู้ระบบ <?= $user['username'] ?>')" name="delete_user" value="<?= $user['user_id']; ?>" class="btn btn-danger btn-sm mt-1"><i class="fa-solid fa-user-xmark"></i></button>
														</form>
